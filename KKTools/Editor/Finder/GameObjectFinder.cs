/**********************************************************
// Author   : K.(k79k06k02k)
// FileName : GameObjectFinder.cs
// Reference: http://wiki.unity3d.com/index.php/FindGameObjects
**********************************************************/
using UnityEngine;
using UnityEditor;
using System.Linq;
...
public class GameObjectFinder : EditorWindow
{
    ...
    {
        var window = (GameObjectFinder)EditorWindow.GetWindow(typeof(GameObjectFinder), false, "Finder", true);
    ...
    private void DrawFilterStatic()
    {
        ...
        if (_filterStatic)
        {
            ...
            if (GUILayout.Button(_invertStaticFilter ? new GUIContent("Not Set", "Objects without this static flag set.")
                                 ...
                                 EditorStyles.miniButton, GUILayout.Width(_INVERT_WIDTH)))
                _invertStaticFilter = !_invertStaticFilter;
        }
    ...
    private void DrawFilterComponent()
    {
        ...
        if (_filterComponent)
        {
            ...
            if (GUILayout.Button(_invertComponentFilter ? new GUIContent("Missing Component", "Objects without this component.")
                                 ...
                                 EditorStyles.miniButton, GUILayout.Width(_INVERT_WIDTH)))
                _invertComponentFilter = !_invertComponentFilter;
        }
    ...
    private void GetComponentTypes()
    {
        ...
        for (int i = 0; i < _componentNames.Length; i++)
        {
            ...
            if (contained) _componentNames[i] = name + '/' + name.Split('/').Last();
        }
    }
    ...
    private void DrawFilterScript()
    {
        ...
        if (_filterScript)
        {
            ...
            if (GUILayout.Button(_invertScriptFilter ? new GUIContent("Missing Script", "Objects without this script.")
                                 ...
                                 EditorStyles.miniButton, GUILayout.Width(_INVERT_WIDTH)))
                _invertScriptFilter = !_invertScriptFilter;
        }
        EditorGUILayout.EndHorizontal();
    }
    ...
    private void DrawFilterTag()
    {
        ...
        if (_filterTag)
        {
            ...
            if (GUILayout.Button(_invertTagFilter ? new GUIContent("Not Tagged", "Objects without this tag.")
                                 ...
                                 EditorStyles.miniButton, GUILayout.Width(_INVERT_WIDTH)))
                _invertTagFilter = !_invertTagFilter;
        }
        EditorGUILayout.EndHorizontal();
    }
    ...
    private void DrawFilterLayer()
    {
        ...
        if (_filterLayer)
        {
            ...
            if (GUILayout.Button(_invertLayerFilter ? new GUIContent("Not In Layer", "Objects not in this layer.")
                                 ...
                                 EditorStyles.miniButton, GUILayout.Width(_INVERT_WIDTH)))
                _invertLayerFilter = !_invertLayerFilter;
        }
        EditorGUILayout.EndHorizontal();
    }
    ...
    private void DrawFilterString()
    {
        ...
        if (_filterString != newFilterString) 
        {
    ...
    private bool _includePrefabChildren = false;
